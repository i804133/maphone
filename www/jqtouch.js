    ...
    $.jQTouch = function(options) {
        ...
        var $body,
            ...
            defaults = {
                ...
                pressDelay: 1000,
                startupScreen: null,
                statusBar: 'black', // other options: black-translucent, black
        ...
        function init(options) {
            ...
            if (jQTSettings.fixedViewport) {
                hairExtensions += '<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/>';
            }
            ...
            if (jQTSettings.fullScreen) {
                ...
                if (jQTSettings.statusBar) {
                    //GHHhairExtensions += '<meta name="apple-mobile-web-app-status-bar-style" content="' + jQTSettings.statusBar + '" />';
                }
            }
